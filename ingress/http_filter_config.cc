...
#include "ingress/http_filter.pb.validate.h"
...
public:
                                                       ...
                                                       FactoryContext &context) override
    {
        ...
        return createFilter(Envoy::MessageUtil::downcastAndValidate<const com::awesome::Decoder &>(
...
private:
    Http::FilterFactoryCb createFilter(const com::awesome::Decoder &proto_config, FactoryContext &)
    {
